...
function CreateDungeon(maptext) {
...
function UpdateDungeon() {
  ...
  if (guardHP > 0 && intruderHP > 0) {
    ...
    // Attack of intruder
    var intruderAttackDamage = Math.floor( Math.random() * 4 ) + 1
    ...
    if (guardHP < 1) {
      ...
      var guardDeathPath = svg.PATH({'d':"M67,37 L53,23 M53,37 L67,23",'fill':'none', 'stroke':"red", 'stroke-width':"2"})
    ...
    if (intruderHP < 1) {
      ...
      var intruderDeathPath = svg.PATH({'d':"M67,67 L53,53 M53,67 L67,53" ,'fill':'none', 'stroke':"blue", 'stroke-width':"2"})
